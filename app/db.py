...
CREATE TABLE IF NOT EXISTS stocks(
  ...
  net_flow REAL NOT NULL DEFAULT 0, total_supply_held INTEGER NOT NULL DEFAULT 0,
  trade_count INTEGER NOT NULL DEFAULT 0, floor REAL NOT NULL, ceiling REAL NOT NULL,
  nominal_supply INTEGER NOT NULL, s0 INTEGER NOT NULL, init_price REAL NOT NULL);
